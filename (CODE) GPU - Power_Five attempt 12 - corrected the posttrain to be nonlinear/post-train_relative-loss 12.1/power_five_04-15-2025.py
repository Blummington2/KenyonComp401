...
optimizer = torch.optim.AdamW(net.parameters(), lr=0.000014) 
# Adding schedulers so that I can alter learning rate mid-run
scheduler = StepLR(optimizer, step_size=1000, gamma=0.94) # LR decay 
...
for epoch in range(iterations): # 'Epoch' keeps track of current training iteration
    ...
    if (4000 < epoch < 30000) or (60000 < epoch < 95000):
