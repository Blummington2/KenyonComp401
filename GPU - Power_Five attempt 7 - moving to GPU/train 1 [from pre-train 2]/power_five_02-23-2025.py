...
optimizer = torch.optim.AdamW(net.parameters(), lr=0.00001) # classic optimizer for gradient descent
# Adding schedulers so that I can alter learning rate mid-run
scheduler = StepLR(optimizer, step_size=2000, gamma=0.99) # LR decay 
...
net.load_state_dict(torch.load('poisson_pre-train_epoch=199000.pt'))
