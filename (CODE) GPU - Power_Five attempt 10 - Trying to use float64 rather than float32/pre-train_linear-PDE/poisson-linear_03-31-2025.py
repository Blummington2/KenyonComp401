...
for epoch in range(iterations): # 'Epoch' keeps track of current training iteration
    ...
    # Loss based on PDE
    f_out = f_linear(interior_x_sampling, interior_y_sampling, interior_z_sampling, net)  # Output of f(x,y,z)
    ...
    if epoch > 20000 and epoch < 200000:
        scheduler.step() # Adjust learning rate gradually
    if epoch > 500000 and epoch < 900000:
