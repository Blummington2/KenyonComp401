...
optimizer = torch.optim.AdamW(net.parameters(), lr=0.0033) 
...
scheduler3 = StepLR(optimizer, step_size=2, gamma=0.03) # alterate LR decay
...
for epoch in range(iterations): # 'Epoch' keeps track of current training iteration
    ...
    """
    loss = mse_interior + 0.1 * mse_boundary # Total loss
    ...
    if epoch > 250000 and epoch < 900000:
