...
However, I haven't given up on this technique because both relative loss and regular loss should theoretically be 0 in a perfect model. So reducing relative loss would be a very good and useful measure of model success. I plan on adjusting my technique by setting a large lower limit on the divisor in this formulation, thus preventing division by small quantities which would have otherwise lead to massive loss gradients. 
