...
- Learning rate schedulers: Allows training to enter more suitable learning rate regimes when training has stalled out. Overall, extremely helpful, escpecially if you want to leave a training run going without checking on it and editing it frequently. Improved my efficiency as a researcher. 
